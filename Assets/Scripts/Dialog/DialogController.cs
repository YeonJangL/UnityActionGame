...
// 일반 팝업 창과 확인 팝업 창 관리하는 DialogControllerAlert, DialogControllerConfirm의 부모 클래스
public class DialogController : MonoBehaviour
{
    // 팝업 창의 트랜스폼
    public Transform window;

    // 팝업창이 보이는지 조회하는 기능, 보이지 않게 설정하기 위한 속성
    public bool Visible
    {
        get
        {
        ...
        private set
        {
            ...
            // visible 의 결과에 따라 활성화를 처리하는 코드
            // 외부에서 간섭 할 수 없다.
        }
    }

    // 가상 함수 : 자식 쪽에서 오버라이딩 할 것이 예상 될 경우 작성되는 키워드
